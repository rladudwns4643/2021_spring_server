...
#define CS_DUMMY_LOGIN		8		// FOR STRESS TEST
...
namespace GRID_TYPE {
	constexpr short eBLANK =		0;
	constexpr short eBLOCKED =		1;
	constexpr short ePLAYER =		2;
}
...
namespace DIR_TYPE {
	...
	constexpr int MV_DOWN = 1;
	constexpr int MV_LEFT = 2;
	constexpr int MV_RIGHT = 3;
}

struct cs_dummy_login {
	unsigned char size;
	char type;
};
